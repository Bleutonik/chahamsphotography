...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    'nav.photos': 'Fotos',
    'nav.destinationWeddings': 'Destination Weddings',
    
    // Destination Weddings
    'dw.subtitle': 'Bodas de Destino',
    'dw.title': 'DESTINATION WEDDINGS',
    'dw.heroDesc': 'Puerto Rico es el escenario perfecto para tu boda soñada. Playas cristalinas, arquitectura colonial y atardeceres inolvidables.',
    'dw.feature1Title': 'Sin Pasaporte (USA)',
    'dw.feature1Desc': 'Puerto Rico es territorio de EE.UU. — tus invitados no necesitan pasaporte si viajan desde Estados Unidos.',
    'dw.feature2Title': 'Cobertura Completa',
    'dw.feature2Desc': 'Fotografía y video profesional desde los preparativos hasta la última canción de la noche.',
    'dw.feature3Title': 'Locaciones Únicas',
    'dw.feature3Desc': 'Desde playas vírgenes hasta fortalezas históricas del siglo XVI en Old San Juan.',
    'dw.feature4Title': 'Experiencia Local',
    'dw.feature4Desc': 'Conocemos cada rincón de la isla para encontrar los mejores escenarios para tu sesión.',
    'dw.locationsTitle': 'Locaciones Populares',
    'dw.locationsDesc': 'Trabajamos en toda la isla, desde las playas más exclusivas hasta los rincones más encantadores.',
    'dw.whyTitle': '¿Por qué Puerto Rico?',
    'dw.why1': 'Puerto Rico ofrece clima tropical durante todo el año, con temperaturas perfectas para bodas al aire libre.',
    'dw.why2': 'La isla cuenta con infraestructura de primer nivel: hoteles boutique, resorts de lujo y venues históricos.',
    'dw.why3': 'No se requiere pasaporte para ciudadanos americanos, lo que facilita la logística para tus invitados.',
    'dw.why4': 'La rica cultura puertorriqueña añade un toque especial y auténtico a cada celebración.',
    'dw.ctaTitle': '¿Planeando Tu Boda en Puerto Rico?',
  ...
  en: {
    ...
    // Destination Weddings
    'dw.subtitle': 'Destination Weddings',
    'dw.title': 'DESTINATION WEDDINGS',
    'dw.heroDesc': 'Puerto Rico is the perfect setting for your dream wedding. Crystal-clear beaches, colonial architecture, and unforgettable sunsets.',
    'dw.feature1Title': 'No Passport Needed (USA)',
    'dw.feature1Desc': 'Puerto Rico is a U.S. territory — your guests don\'t need a passport when traveling from the United States.',
    'dw.feature2Title': 'Full Coverage',
    'dw.feature2Desc': 'Professional photography and videography from preparations to the last song of the night.',
    'dw.feature3Title': 'Unique Locations',
    'dw.feature3Desc': 'From pristine beaches to 16th-century historic fortresses in Old San Juan.',
    'dw.feature4Title': 'Local Expertise',
    'dw.feature4Desc': 'We know every corner of the island to find the best settings for your session.',
    'dw.locationsTitle': 'Popular Locations',
    'dw.locationsDesc': 'We work across the entire island, from exclusive beaches to the most charming hidden spots.',
    'dw.whyTitle': 'Why Puerto Rico?',
    'dw.why1': 'Puerto Rico offers tropical weather year-round, with perfect temperatures for outdoor weddings.',
    'dw.why2': 'The island features world-class infrastructure: boutique hotels, luxury resorts, and historic venues.',
    'dw.why3': 'No passport required for U.S. citizens, making logistics easy for your guests.',
    'dw.why4': 'Puerto Rico\'s rich culture adds a special and authentic touch to every celebration.',
    'dw.ctaTitle': 'Planning Your Wedding in Puerto Rico?',
