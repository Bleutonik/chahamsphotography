  ...
  return <section id="servicios" className="py-20 md:py-32 bg-card">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => <div key={service.title} className="group p-8 rounded-lg bg-background hover:bg-muted/50 border border-transparent hover:border-primary/20 shadow-soft hover:shadow-elegant transition-all duration-500" style={{
