            ...
            <div className="space-y-6 mb-10">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a className="font-body text-muted-foreground hover:text-primary transition-colors" href="mailto:Cpartspr@gmail.com">Cpartspr@gmail.com</a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a className="font-body text-muted-foreground hover:text-primary transition-colors" href="https://wa.me/17873630620" target="_blank" rel="noopener noreferrer">
                    +1 (787)-363-0620
                  </a>
                </div>
              </div>
